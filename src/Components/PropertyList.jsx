  ...
  return (
    <div className="w-full max-w-4xl bg-white rounded-lg shadow-lg overflow-hidden">
      ...
      <div className="p-6 bg-white border-b">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">Cari Properti</h2>
        <div className="flex gap-4">
          <div className="flex-1 relative">
            <input
              type="text"
              placeholder="Masukkan lokasi (contoh: Medan Selayang)"
              value={location}
        ...
        {!searched ? (
          ...
          <div className="p-4">
            {properties.map((property) => (
              <motion.div
                key={property.id}
                className="p-4 border border-gray-200 rounded-lg mb-4 hover:shadow-md transition-all cursor-pointer"
